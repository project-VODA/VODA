...
export const getUserHandicap = async () => {
  ...
  console.log('res는', res.data.userHandicap);
  return res.data.userHandicap;
}
...
export default class ToolbarComponentClass extends Component {
  ...
  render() {
    ...
    const isHandicap = getUserHandicap();
      ...
      <AppBar className="toolbar" id={toolbarID}>
        <Toolbar className="toolbar">
          ...
          <div className="buttonsContent">
            ...
            <span>
              {isHandicap === 1 ? (<SettingButton tabIndex={1} id='hearExpression' text='표정 듣기' onClick={this.hearExpression} aria-label='표정 듣기 버튼입니다.'  />
